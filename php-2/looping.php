...
Soal No 1
Looping I Love PHP
Lakukan Perulangan (boleh for/while/do while) sebanyak 20 iterasi. Looping terbagi menjadi dua: Looping yang pertama Ascending (meningkat)dan Looping yang ke dua menurun (Descending). Output: LOOPING PERTAMA
10 - I Love PHP
12 - I Love PHP
14 - I Love PHP
16 - I Love PHP
...
foreach ($items as $item) {
    ...
    print_r($itemAssoc); // Print the associative array
    echo "<br>";
}
